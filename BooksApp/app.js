...
router.route('/')
      ...
      .post(function (req, res, next) {
          var item = req.body;
          booksCollection.insert(item, function (err, docs) {
              res.send({
                  status: 'Item added',
                  itemId: item._id
              });
...
router.route('/:id')
      .delete(function (req, res, next) {
          ...
          booksCollection.remove(lookup, function (err, results) {
